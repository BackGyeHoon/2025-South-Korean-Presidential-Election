      ...
      {details && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6">
              <h2 className="text-xl font-bold mb-4 text-primary">주요 경력</h2>
              <ul className="space-y-2 list-disc list-inside">
                {details.career.map((item: string, index: number) => (
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6">
              <h2 className="text-xl font-bold mb-4 text-primary">주요 성과</h2>
              <ul className="space-y-2 list-disc list-inside">
